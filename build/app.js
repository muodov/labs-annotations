...
// load the styles
var content = __webpack_require__(/*! !../~/css-loader??ref--0-1!../~/sass-loader/lib/loader.js!./styles.scss */ 38);
...
module.exports = __webpack_require__(/*! ./lib/range */ 51)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__location_js__ = __webpack_require__(/*! ./location.js */ 6);
...
function renderPanel(xpathRange, snippet) {
    ...
    submitBut.addEventListener('click', e => {
        let url = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__location_js__["a" /* getLocation */])();
        if (url.indexOf('?') !== -1) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(/*! axios */ 19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__annotate_js__ = __webpack_require__(/*! ./annotate.js */ 16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__location_js__ = __webpack_require__(/*! ./location.js */ 6);
...
function submitAnnotation(data) {
    ...
    if (annotation) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.put(window.ANNOTATION_SERVER + '/annotations/' + annotation.id, annotation, {params: {url: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__location_js__["a" /* getLocation */])()}});
    } else {    
        annotation = {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a
            .post(window.ANNOTATION_SERVER + '/annotations/', annotation, {params: {url: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__location_js__["a" /* getLocation */])()}})
            .then(resp => {
                window.surfly_annotations.push(resp.data);
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__annotate_js__["a" /* markAnnotation */])(resp.data);
...
function fetchAnnotations(url) {
    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a
        .get(window.ANNOTATION_SERVER + '/annotations/', {params: {url: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__location_js__["a" /* getLocation */])()}})
        .then(resp => {
            window.surfly_annotations = resp.data;
            window.surfly_annotations.forEach(annotation => {
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__annotate_js__["a" /* markAnnotation */])(annotation);
            });
        })
        .catch(err => {
            console.error(err)
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(/*! ./../~/process/browser.js */ 14)))

/***/ }),
/* 6 */
/* exports provided: getLocation */
/* exports used: getLocation */
/*!****************************!*\
  !*** ./client/location.js ***!
  \****************************/
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__button_js__ = __webpack_require__(/*! ./button.js */ 15);
...
axios.CancelToken = __webpack_require__(/*! ./cancel/CancelToken */ 21);
...
module.exports = __webpack_require__(/*! ./lib */ 41)['default'];
...
var _ancestors = __webpack_require__(/*! ancestors */ 18);

var _ancestors2 = _interopRequireDefault(_ancestors);

var _indexOf = __webpack_require__(/*! index-of */ 43);
...
module.exports = __webpack_require__(/*! ./lib/xpath */ 47)
...
var _domException = __webpack_require__(/*! ./dom-exception */ 46);
...
var stylesInDom = {},
	...
	fixUrls = __webpack_require__(/*! ./fixUrls */ 49);
...
var _domSeek = __webpack_require__(/*! dom-seek */ 40);

var _domSeek2 = _interopRequireDefault(_domSeek);

var _simpleXpathPosition = __webpack_require__(/*! simple-xpath-position */ 45);
